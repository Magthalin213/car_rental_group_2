...
private String type;
public CustomerDto() {}
public CustomerDto(int id, String firstName, String lastName, String email, String phoneNumber, int vehicleId,
...
public CustomerDto(String firstName, String lastName, String email, String phoneNumber, int vehicleId, int customerId,
